    ...
    <div class="col-xs-12">
        <section class="panel panel-primary form-wizard" id="w4">
            <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Importar imágenes de artículos</h2>
            </header>
                    ...
                    <div class="wizard-progress wizard-progress-lg">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div id="wiz-archivo" class="tab-pane active">
                                        <?php require $baseURL . 'code/accion_administracion_importar_imagenes_articulo_archivo_form.php'; ?>
                                    ...
                                    <div id="wiz-guardado" class="tab-pane">
                                        <?php require $baseURL . 'code/accion_administracion_importar_imagenes_articulo_guardado.php'; ?>    
                                    </div>
    ...
    $(function()
        {
            ...
            var urlDestino ='code/accion_administracion_importar_imagenes_articulo_submit.php'; //url del archivo que soportará la recepción de la info
            var separadorTipo = ';';
                        ...
                        if ( validated ) {
                            $("#loading3").html('<div class="loading-overlay-showing" data-loading-overlay="" data-loading-overlay-options="{ &quot;startShowing&quot;: true }" >' + 
                                ...
                                $.ajax({
                                    ...
                                    url: "code/accion_administracion_importar_imagenes_articulo_guardado_submit.php",
                        ...
                        success: function(data, textStatus, jqXHR)
                        {
                            if(typeof data.error === 'undefined')
                            {
                                    ...
                                    //alert('exito archivos');
                                     ...
                                     stopSpinner();
                                     $('#wiz-validacion').load('code/accion_administracion_importar_imagenes_articulo_validar_archivo.php?file=' + data.files + 
