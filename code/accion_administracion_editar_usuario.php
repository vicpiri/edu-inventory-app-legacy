...
<section class="panel-primary">
    <header class="panel-heading">
            ...
            <h2 class="panel-title">Editando el usuario <?php echo $_GET['username'];?></h2>
    </header>
        ...
        <div class="panel-body" id="loadingSpinnerPanel" data-loading-overlay >
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-9">
                                    <input name="fechanacimiento" type="text" class="form-control" id="inputFechaNacimiento" title="Este campo es obligatorio" required>
                            </div>
                    </div>
                    <div class="form-group">
...
$("#tipo").load("code/accion_administracion_editar_usuario_rellena_tipos.php?userlevel=<?php echo $_SESSION['userlevel']; ?>&editeduser=<?php echo $_GET['username'] ?>");
$("#contenedorvisor").load("code/accion_administracion_editar_usuario_rellena_foto.php?editeduser=<?php echo $_GET['username'] ?>");

$.get('code/accion_administracion_editar_usuario_rellena_nombre.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
    $('#inputNombre').val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_apellido1.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
   $("#inputApellido1").val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_apellido2.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
    $("#inputApellido2").val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_mail.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
    $("#inputMail").val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_telefono1.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
    $("#inputTelefono1").val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_telefono2.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
    $("#inputTelefono2").val(result);
});
$.get('code/accion_administracion_editar_usuario_rellena_fechanacimiento.php?editeduser=<?php echo $_GET['username'] ?>', function(result) {
