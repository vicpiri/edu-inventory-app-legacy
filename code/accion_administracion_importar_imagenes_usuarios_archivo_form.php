...
<div class="alert alert-warning col-md-6 col-md-offset-3">
        ...
        <strong>¡Atención!</strong> Debe seleccionar un archivo ZIP que contenga las imágenes de los usuarios. <br/> <br/>
        El nombre de cada uno de los archivos debe ser el código del usuario representado en la foto.
        <br/> <br/>
