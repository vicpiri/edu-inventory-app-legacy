...
if (isset($_POST['datos'])){
    ...
    if ($continuar){
        ...
        switch ($_POST['tipo_archivo']){
            case 'personal':
                include 'accion_administracion_importar_usuarios_guardado_submit_personal.php';
                
                break;
            case 'grupos':
                include 'accion_administracion_importar_usuarios_guardado_submit_grupos.php';
                break;
            case 'alumnado':
                include 'accion_administracion_importar_usuarios_guardado_submit_alumnado.php';
                break;
            default :
                break;
        }
        ...
        <script>
            ...
            $('#subframe').load('<?php echo $baseURLClient; ?>code/accion_administracion_importar_usuarios.php');
        </script>
