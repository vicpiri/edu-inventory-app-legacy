    ...
    <div class="col-xs-12">
        <section class="panel panel-primary form-wizard" id="w4">
            <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Importar lote de usuarios</h2>
            </header>
                    ...
                    <div class="wizard-progress wizard-progress-lg">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div id="wiz-archivo" class="tab-pane active">
                                        <?php require $baseURL . 'code/accion_administracion_importar_usuarios_archivo_form.php'; ?>
                                    ...
                                    <div id="wiz-validacion" class="tab-pane">
                                        <div class="panel-body" style="min-height: 150px; position: relative;">
                                            ...
                                            <div class="alert alert-warning col-md-6 col-md-offset-3 text-center">
                                                Analizando el archivo. Esto puede tardar unos minutos. <br/>Por favor, espere...
                                            </div>
                                                
                                        </div>        
                                    </div>
                                    <div id="wiz-guardado" class="tab-pane">
                                        <?php require $baseURL . 'code/accion_administracion_importar_usuarios_guardado.php'; ?>    
                                    </div>
    ...
    $(function()
        {
            ...
            var urlDestino ='code/accion_administracion_importar_usuarios_submit.php'; //url del archivo que soportará la recepción de la info
            ...
            var $w4finish = $('#w4').find('ul.pager li.finish'),
                        ...
                        if ( validated ) {
                            $("#loading3").html('<div class="loading-overlay-showing" data-loading-overlay="" data-loading-overlay-options="{ &quot;startShowing&quot;: true }" >' + 
                                ...
                                $.ajax({
                                    ...
                                    url: "code/accion_administracion_importar_usuarios_guardado_submit.php",
                ...
                $('#w4').bootstrapWizard({
                        ...
                        onTabShow: function( tab, navigation, index ) {
                                ...
                                //Atención, el indice de tabuladores empieza en 0 (0 es el primer tab)
                                if (index === 1){
                                    $("#loading2").html('<div class="loading-overlay-showing" data-loading-overlay="" data-loading-overlay-options="{ &quot;startShowing&quot;: true }" >' + 
                                    '<div class="loading-overlay" style="border-radius: 0px 0px 5px 5px;">' + 
                                    '<div class="loader black"></div></div>');
                                    uploadFiles();// Al mostrar el tab de validación, enviamos los archivos
                                }
                        }
                });
                        ...
                        success: function(data, textStatus, jqXHR)
                        {
                            if(typeof data.error === 'undefined')
                            {
                                    ...
                                    //alert('exito archivos');
                                     ...
                                     stopSpinner();
                                     $('#wiz-validacion').load('code/accion_administracion_importar_usuarios_validar_archivo.php?file=' + data.files); 
                            }
                            else
                            {
