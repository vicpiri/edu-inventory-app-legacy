<?php
    ...
    $sql ='SELECT COUNT(DISTINCT usuario) FROM salidas WHERE devuelto = "f" AND usuario_presta LIKE "' . $usuario . '"';
            ...
            <div class="panel-body">
                <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                    <div class="summary">
                                            <h4 class="title">Material Prestado por mi</h4>
                                            <div class="info">
                                    ...
                                    <div class="summary-footer">
                                        <?php
                                            $lburl = $baseURLClient . "/modules/prestamos/code/plugin_TMP_WIDG_prestado_por_mi_vertodos.php";
