...
if (file_exists($pathroot . '/modules/' . $module . '/acciones.php')){
    ...
    foreach ((array)$acciones_modulo as $accion){
        ...
        if (isset($rows['accionkey'])){
            ...
            } Esta parte del código está pendiente de ser eliminada. Hay que estudiar el impacto de la comprobación de versión de la acción en la base de datos*/
        }else{
            $modulo_instalado = false;
        }
    }
